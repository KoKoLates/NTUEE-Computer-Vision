...
def main():
    ...
    parser.add_argument('--image_path', default='./data/ex.png', help='path to input image')
    parser.add_argument('--gt_bf_path', default='./data/ex_gt_bf.png', help='path to ground truth bf image')
    parser.add_argument('--gt_jbf_path', default='./data/ex_gt_jbf.png', help='path to ground trut jbf image')
